...
The webpage is generated by a **React app**. The web-app is usable under https://rappsilberlab.org/rapcluster/. 
...
### Run with Docker
You can run the frontend and backend with docker. Simply running
sudo docker compose up --build -d
Should mae the app available under
http://localhost:8088/rapcluster
